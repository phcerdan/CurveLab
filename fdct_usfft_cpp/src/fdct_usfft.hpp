...
//  wege w, fy[s][w] is the second coordinate of the frequency center of
//  curvelet of scale s and wedge w nx -- for scale s and wege w, nx[s][w] is
//  the first dimension of the curvelet matrix of scale s and wedge w ny -- for
//  scale s and wege w, ny[s][w] is the second dimension of the curvelet matrix
//  of scale s and wedge w
