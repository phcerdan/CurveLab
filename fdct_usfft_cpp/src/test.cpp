...
int main(int argc, char** argv) {
  ...
  ck1 = clock();
  cout << "FDCT_USFFT_  takes " << double(ck1 - ck0) / CLOCKS_PER_SEC
       << " seconds " << endl;
  ck0 = ck1;
  ...
  ck1 = clock();
  cout << "AFDCT_USFFT_ takes " << double(ck1 - ck0) / CLOCKS_PER_SEC
       << " seconds " << endl;
  ck0 = ck1;
  ...
  ck1 = clock();
  cout << "IFDCT_USFFT_ takes " << double(ck1 - ck0) / CLOCKS_PER_SEC
       << " seconds " << endl;
  ck0 = ck1;
  ...
  // cerr<<"x,x "<<a0<<endl;  //cerr<<"s,x "<<a1<<endl;  //cerr<<"c,c
  // "<<a2<<endl;
